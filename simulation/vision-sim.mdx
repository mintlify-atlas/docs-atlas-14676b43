...
description: "Converts PhotonVision synthetic AprilTag results into Limelight NetworkTables entries so VisionSubsystem can process simulated and real data identically."
---
