...
The left roller runs on the **CANivore** bus (comp bot) while the right roller uses the **roboRIO** bus. Motors run in **Coast** neutral mode to prevent fuel damage on sudden stops.
